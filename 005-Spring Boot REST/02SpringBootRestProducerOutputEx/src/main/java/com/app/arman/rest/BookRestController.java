...
//=====================================================================================
	...
	public ResponseEntity<List<Book>> getAllBooks() {
		return new ResponseEntity<List<Book>>(Arrays.asList(new Book(980, "CORE JAVA", 200.0),
